...
<div class="inner-banner style-6">
	<img class="center-image" src="<?php echo get_template_directory_uri() ?>/img/detail/bg_2.jpg" alt="">
			...
			<div class="row">
				<div class="col-xs-12 col-md-8 col-md-offset-2 mx-auto">
		  			<ul class="banner-breadcrumb color-white clearfix">
		  				...
		  				<li><a class="link-dr-blue-2" href="#">tour</a> /</li>
		  				<li>
							<span>
								<?php
									the_taxonomy_breadcrumb(get_the_ID(),'tour_categories') ;
								?>
							</span>
						</li>
		  			</ul>
						...
						<div class="swiper-container thumbnails-preview" data-autoplay="0" data-loop="1" data-speed="500" data-center="0" data-slides-per-view="1">
			                <div class="swiper-wrapper">
		                    	<div class="swiper-slide active" data-val="0">
		                    		 <img class="img-responsive img-full" src="<?php echo get_template_directory_uri() ?>/img/detail/m_slide_1.jpg" alt="">
		                    	</div>
		                    	<div class="swiper-slide" data-val="1">
		                    		 <img class="img-responsive img-full" src="<?php echo get_template_directory_uri() ?>/img/detail/m_slide_2.jpg" alt="">
		                    	</div>
		                    	<div class="swiper-slide" data-val="2">
		                    		 <img class="img-responsive img-full" src="<?php echo get_template_directory_uri() ?>/img/detail/m_slide_3.jpg" alt="">
		                    	</div>
		                    	<div class="swiper-slide" data-val="3">
		                    		 <img class="img-responsive img-full" src="<?php echo get_template_directory_uri() ?>/img/detail/m_slide_4.jpg" alt="">		 
		                    	</div>
		                    	<div class="swiper-slide" data-val="4">
		                    		 <img class="img-responsive img-full" src="<?php echo get_template_directory_uri() ?>/img/detail/m_slide_5.jpg" alt="">           		 
		                    	</div>
		                    </div>
			            ...
			            data-add-slides="5">
			                <div class="swiper-wrapper">
								<div class="swiper-slide current active" data-val="0">
									<img class="img-responsive img-full" src="<?php echo get_template_directory_uri() ?>/img/detail/m_slide_1s.jpg" alt="">
								</div>
								<div class="swiper-slide" data-val="1">
									<img class="img-responsive img-full" src="<?php echo get_template_directory_uri() ?>/img/detail/m_slide_2s.jpg" alt="">
								</div>
								<div class="swiper-slide" data-val="2">
									<img class="img-responsive img-full" src="<?php echo get_template_directory_uri() ?>/img/detail/m_slide_3s.jpg" alt="">
								</div>
								<div class="swiper-slide" data-val="3">
									<img class="img-responsive img-full" src="<?php echo get_template_directory_uri() ?>/img/detail/m_slide_4s.jpg" alt="">
								</div>
								<div class="swiper-slide" data-val="4">
									<img class="img-responsive img-full" src="<?php echo get_template_directory_uri() ?>/img/detail/m_slide_5s.jpg" alt="">
								</div>
							</div>
       		...
       		<div class="col-xs-12 col-md-4">
       			<div class="right-sidebar">
					...
					<div class="popular-tours bg-grey-2">
						...
						<div class="hotel-small style-2 clearfix">
							<a class="hotel-img black-hover" href="#">
								<img class="img-responsive radius-3" src="<?php echo get_template_directory_uri() ?>/img/detail/hotel_small_1.jpg" alt="">
						...
						<div class="hotel-small style-2 clearfix">
							<a class="hotel-img black-hover" href="#">
								<img class="img-responsive radius-3" src="<?php echo get_template_directory_uri() ?>/img/detail/hotel_small_2.jpg" alt="">
								<div class="tour-layer delay-1"></div>        						
							</a>
							<div class="hotel-desc">
		    					<h5><span class="color-dark-2">from <strong>$273</strong></span></h5>
						...
						<div class="hotel-small style-2 clearfix">
							<a class="hotel-img black-hover" href="#">
								<img class="img-responsive radius-3" src="<?php echo get_template_directory_uri() ?>/img/detail/hotel_small_3.jpg" alt="">
								<div class="tour-layer delay-1"></div>        						
							</a>
							<div class="hotel-desc">
		    					<h5><span class="color-dark-2">from <strong>$273</strong></span></h5>
					...
					<div class="help-contact bg-grey-2">
						...
						<a class="help-phone color-dark-2 link-dr-blue" href="tel:0200059600"><img src="<?php echo get_template_directory_uri() ?>/img/detail/phone24-dark.png" alt="">020 00 59 600</a>
						<a class="help-mail color-dark-2 link-dr-blue" href="mailto:let’s_travel@world.com"><img src="<?php echo get_template_directory_uri() ?>/img/detail/letter-dark.png" alt="">let’s_travel@world.com</a>
					</div>										      				
       			</div>       			
       		</div>
       	</div>
	       	...
	       	<div class="row">
		          ...
		          <div class="hotel-item">
		          	 <div class="radius-top">
		          	 	 <img src="<?php echo get_template_directory_uri() ?>/img/home_3/pop_hotel_1.jpg" alt="">
		             ...
		             <a href="#" class="c-button color-dr-blue hv-o b-50 fr"><img src="<?php echo get_template_directory_uri() ?>/img/loc_icon_small_drak.png" alt="">view on map</a>
		             </div>
		          </div>      			
	       		</div>
	       		<div class="col-mob-12 col-xs-6 col-sm-6 col-md-3">
			          <div class="hotel-item">
			          	 <div class="radius-top">
			          	 	 <img src="<?php echo get_template_directory_uri() ?>/img/home_3/pop_hotel_2.jpg" alt="">
			          	 	   <div class="price price-s-1">$273</div>
			          	 </div>
			          	 <div class="title clearfix">
	       		...
	       		<div class="col-mob-12 col-xs-6 col-sm-6 col-md-3">
			          <div class="hotel-item">
			          	 <div class="radius-top">
			          	 	 <img src="<?php echo get_template_directory_uri() ?>/img/home_3/pop_hotel_3.jpg" alt="">
			          	 	   <div class="price price-s-1">$273</div>
			          	 </div>
			          	 <div class="title clearfix">
			          	     <h4><b>royal Hotel</b></h4>
	       		...
	       		<div class="col-mob-12 col-xs-6 col-sm-6 col-md-3">
			          <div class="hotel-item">
			          	 <div class="radius-top">
			          	 	 <img src="<?php echo get_template_directory_uri() ?>/img/home_3/pop_hotel_4.jpg" alt="">
			          	 	   <div class="price price-s-1">$273</div>
			          	 </div>
			          	 <div class="title clearfix">
			          	     <h4><b>sheraton Hotel</b></h4>
