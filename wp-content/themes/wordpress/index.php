<?php get_header() ?>
			...
			<div class="swiper-container main-slider" data-autoplay="5000" data-loop="1" data-speed="900" data-center="0" data-slides-per-view="1">
				<div class="swiper-wrapper">
					<div class="swiper-slide active" data-val="0"> 
					  <div class="clip">
							<div class="bg bg-bg-chrome act" style="background-image:url(http://localhost:8000/sannatour/wp-content/themes/wordpress/img/home_9/slide_1.jpg)">
							</div>
					  </div>
										...
										<div class="col-md-12">
											<div class="main-title style-1 vert-title">
												<div class="top-weather-info delay-1">
													<img src="http://localhost:8000/sannatour/wp-content/themes/wordpress/img/home_9/slide_icon.png" alt="">
												</div>
												...
												<p class="color-white-op delay-2">Curabitur nunc erat, consequat in erat ut, congue bibendum nulla. Suspendisse id pharetra lacus, et hendrerit mi quis leo elementum. Lorem ipsum dolor sit.</p>
													<div class="row">
														<div class="col-xs-12 col-sm-6">
															<a href="#" class="c-button b-60 bg-blue-3 hv-transparent delay-2 fr"><img src="http://localhost:8000/sannatour/wp-content/themes/wordpress/img/loc_icon.png" alt=""><span>view our tours</span></a>											
														</div>
														<div class="col-xs-12 col-sm-6">
                            	...
                            	<div class="row">
                            		<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            		    ...
                            		    <h5>Your Destinationss</h5>
                            		      <div class="input-style-1">
                            		      	 <img src="http://localhost:8000/sannatour/wp-content/themes/wordpress/img/loc_icon_small.png" alt="">
                            		...
                            		<div class="col-lg-2 col-md-4 col-sm-4 col-xs-6">
                            		  <div class="tabs-block">
                            		    <h5>Check In</h5>
                            		      <div class="input-style-1">
                            		      	 <img src="http://localhost:8000/sannatour/wp-content/themes/wordpress/img/calendar_icon.png" alt="">
                            		...
                            		<div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">
                            		  <a href="#" class="c-button b-60 bg-white"><i class="fa fa-search"></i><span>search now</span></a>
                            		</div>
                            	</div>
                            </div>
						</div>
	...
	<!-- TOURS (ALL) -->
	<div class="main-wraper pb-3">
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-8 col-sm-offset-2 mx-auto">
					<div class="second-title">
						<h4 class="subtitle color-dr-blue-2">top booking tours</h4>
					  ...
					  <div class="swiper-wrapper">
							...
							<?php
								if ( have_posts() ) {
									...
									while ( have_posts() ) {
										the_post();
										get_template_part( 'template-parts/body/content','tours' );
									}
								} else {
			...
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-md-3">
					<div class="world-city black-hover">
						<div class="tour-layer delay-1"></div>
						<img class="center-image" src="http://localhost:8000/sannatour/wp-content/themes/wordpress/img/home_9/city_1.jpg" alt="">
						<div class="vertical-align">
				...
				<div class="col-xs-12 col-sm-6 col-md-3">
					<div class="world-country">
						<img class="center-image" src="http://localhost:8000/sannatour/wp-content/themes/wordpress/img/home_9/country_1.png" alt="">
						<div class="vertical-align">
				...
				<div class="col-xs-12 col-sm-6 col-md-3">
					<div class="world-city black-hover">
						<div class="tour-layer delay-1"></div>
						<img class="center-image" src="http://localhost:8000/sannatour/wp-content/themes/wordpress/img/home_9/city_2.jpg" alt="">
						<div class="vertical-align">
				...
				<div class="col-xs-12 col-sm-6 col-md-3">
					<div class="world-country">
						<img class="center-image" src="http://localhost:8000/sannatour/wp-content/themes/wordpress/img/home_9/country_2.png" alt="">
						<div class="vertical-align">
				...
				<div class="col-xs-12 col-sm-6 col-md-3">
					<div class="world-city black-hover">
						<div class="tour-layer delay-1"></div>
						<img class="center-image" src="http://localhost:8000/sannatour/wp-content/themes/wordpress/img/home_9/city_3.jpg" alt="">
						<div class="vertical-align">
				...
				<div class="col-xs-12 col-sm-6 col-md-3">
					<div class="world-country">
						<img class="center-image" src="http://localhost:8000/sannatour/wp-content/themes/wordpress/img/home_9/country_3.png" alt="">
						<div class="vertical-align">
				...
				<div class="col-xs-12 col-sm-6 col-md-3">
					<div class="world-city black-hover">
						<div class="tour-layer delay-1"></div>
						<img class="center-image" src="http://localhost:8000/sannatour/wp-content/themes/wordpress/img/home_9/city_4.jpg" alt="">
						<div class="vertical-align">
				...
				<div class="col-xs-12 col-sm-6 col-md-3">
					<div class="world-country">
						<img class="center-image" src="http://localhost:8000/sannatour/wp-content/themes/wordpress/img/home_9/country_4.png" alt="">
						<div class="vertical-align">
     	...
     	<div class="swiper-container" data-autoplay="0" data-loop="1" data-speed="1000" data-center="0" data-slides-per-view="1" id="tour-slide-2">
		    <div class="swiper-wrapper">
			  	<div class="swiper-slide">
			  		<img class="center-image" src="http://localhost:8000/sannatour/wp-content/themes/wordpress/img/home_9/bg_1.jpg" alt="">
			  	...
			  	<div class="swiper-slide">
			  		<img class="center-image" src="http://localhost:8000/sannatour/wp-content/themes/wordpress/img/home_9/bg_2.jpg" alt="">
					<div class="slider-tour style-2 padd-100">
						<div class="container">
							<div class="row">
								<div class="col-xs-12 col-sm-10 col-sm-offset-1 mx-auto">
			  	...
			  	<div class="swiper-slide">
			  		<img class="center-image" src="http://localhost:8000/sannatour/wp-content/themes/wordpress/img/home_9/bg_3.jpg" alt="">
					<div class="slider-tour style-2 padd-100">
						<div class="container">
							<div class="row">
								<div class="col-xs-12 col-sm-10 col-sm-offset-1 mx-auto">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-8 col-sm-offset-2 mx-auto">
					<div class="second-title">
						...
						<h2 class="color-dark-2">popular cruises</h2>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-md-4">
					<div class="hotel-small style-2 clearfix">
						<a class="hotel-img black-hover" href="#">
							<img class="img-responsive radius-0" src="http://localhost:8000/sannatour/wp-content/themes/wordpress/img/home_9/cruise_1.jpg" alt="">
							<div class="tour-layer delay-1"></div>        						
						</a>
					...
					<div class="hotel-small style-2 clearfix">
						<a class="hotel-img black-hover" href="#">
							<img class="img-responsive radius-0" src="http://localhost:8000/sannatour/wp-content/themes/wordpress/img/home_9/cruise_2.jpg" alt="">
							<div class="tour-layer delay-1"></div>        						
						</a>
						<div class="hotel-desc">
	    					<h5><span class="color-dark-2"><strong>$273</strong> / person</span></h5>	
					...
					<div class="hotel-small style-2 clearfix">
						<a class="hotel-img black-hover" href="#">
							<img class="img-responsive radius-0" src="http://localhost:8000/sannatour/wp-content/themes/wordpress/img/home_9/cruise_3.jpg" alt="">
							<div class="tour-layer delay-1"></div>        						
						</a>
						<div class="hotel-desc">
	    					<h5><span class="color-dark-2"><strong>$273</strong> / person</span></h5>
					...
					<div class="hotel-small style-2 clearfix">
						<a class="hotel-img black-hover" href="#">
							<img class="img-responsive radius-0" src="http://localhost:8000/sannatour/wp-content/themes/wordpress/img/home_9/cruise_4.jpg" alt="">
							<div class="tour-layer delay-1"></div>        						
						</a>
						<div class="hotel-desc">
	    					<h5><span class="color-dark-2"><strong>$273</strong> / person</span></h5>
				...
				<div class="col-xs-12 col-sm-6 col-md-4">
					<div class="hotel-small style-2 clearfix">
						<a class="hotel-img black-hover" href="#">
							<img class="img-responsive radius-0" src="http://localhost:8000/sannatour/wp-content/themes/wordpress/img/home_9/cruise_5.jpg" alt="">
							<div class="tour-layer delay-1"></div>        						
						</a>
						<div class="hotel-desc">
	    					<h5><span class="color-dark-2"><strong>$273</strong> / person</span></h5>
					...
					<div class="hotel-small style-2 clearfix">
						<a class="hotel-img black-hover" href="#">
							<img class="img-responsive radius-0" src="http://localhost:8000/sannatour/wp-content/themes/wordpress/img/home_9/cruise_6.jpg" alt="">
							<div class="tour-layer delay-1"></div>        						
						</a>
						<div class="hotel-desc">
	    					<h5><span class="color-dark-2"><strong>$273</strong> / person</span></h5>
					...
					<div class="hotel-small style-2 clearfix">
						<a class="hotel-img black-hover" href="#">
							<img class="img-responsive radius-0" src="http://localhost:8000/sannatour/wp-content/themes/wordpress/img/home_9/cruise_7.jpg" alt="">
							<div class="tour-layer delay-1"></div>        						
						</a>
						<div class="hotel-desc">
	    					<h5><span class="color-dark-2"><strong>$273</strong> / person</span></h5>
					...
					<div class="hotel-small style-2 clearfix">
						<a class="hotel-img black-hover" href="#">
							<img class="img-responsive radius-0" src="http://localhost:8000/sannatour/wp-content/themes/wordpress/img/home_9/cruise_8.jpg" alt="">
							<div class="tour-layer delay-1"></div>        						
						</a>
						<div class="hotel-desc">
	    					<h5><span class="color-dark-2"><strong>$273</strong> / person</span></h5>
				...
				<div class="col-xs-12 col-sm-12 col-md-4">
					<div class="item-block style-5 hover-blue-3">
						<img class="center-image" src="http://localhost:8000/sannatour/wp-content/themes/wordpress/img/home_9/special.jpg" alt="">
						<div class="tour-layer delay-1"></div>
						<div class="vertical-align">
	...
	<div class="main-wraper  bg-grey-2">
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-8 col-sm-offset-2 mx-auto">
					<div class="second-title">
						<h4 class="subtitle color-dr-blue-2">cruise line</h4>
						<h2 class="color-dark-2">BEST CRUISE LINE ITINERARIES</h2>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-md-3">
					<div class="icon-block style-3 bg-white">
						...
						<img class="icon-img" src="http://localhost:8000/sannatour/wp-content/themes/wordpress/img/home_9/icon_1.jpg" alt="">
						<div class="rate-wrap clearfix">
	          	          	<div class="rate">
								<span class="fas fa-star color-yellow"></span>
								<span class="fas fa-star color-yellow"></span>
				...
				<div class="col-xs-12 col-sm-6 col-md-3">
					<div class="icon-block style-3 bg-white">
						<div class="icon-price color-dark-2">cruise from <strong>$750</strong></div>
						<img class="icon-img" src="http://localhost:8000/sannatour/wp-content/themes/wordpress/img/home_9/icon_2.jpg" alt="">
						<div class="rate-wrap clearfix">
	          	          	<div class="rate">
								<span class="fas fa-star color-yellow"></span>
								<span class="fas fa-star color-yellow"></span>
				...
				<div class="col-xs-12 col-sm-6 col-md-3">
					<div class="icon-block style-3 bg-white">
						<div class="icon-price color-dark-2">cruise from <strong>$750</strong></div>
						<img class="icon-img" src="http://localhost:8000/sannatour/wp-content/themes/wordpress/img/home_9/icon_3.jpg" alt="">
						<div class="rate-wrap clearfix">
	          	          	<div class="rate">
								<span class="fas fa-star color-yellow"></span>
								<span class="fas fa-star color-yellow"></span>
				...
				<div class="col-xs-12 col-sm-6 col-md-3">
					<div class="icon-block style-3 bg-white">
						<div class="icon-price color-dark-2">cruise from <strong>$750</strong></div>
						<img class="icon-img" src="http://localhost:8000/sannatour/wp-content/themes/wordpress/img/home_9/icon_4.jpg" alt="">
						<div class="rate-wrap clearfix">
	          	          	<div class="rate">
								<span class="fas fa-star color-yellow"></span>
								<span class="fas fa-star color-yellow"></span>
